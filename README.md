## Rubik's Cube Kociemba Algorithm
  ...
  Hello! This is my project for solving 10K scrambled cubes from the input inside CubeSolver. The project combines the performance of parallel computing in C++ with a smart and relatively efficient algorithm.
